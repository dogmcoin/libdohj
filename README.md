[![Build Status](https://travis-ci.org/dogmcoin/libdohj.svg?branch=master)](https://travis-ci.org/dogmcoin/libdohj)

### Welcome to libdohj

The libdohj library is a lightweight wrapper library around the bitcoinj Java library,
enabling support for Dogmcoin (pull requests for support for other altcoins would
be welcomed).
...
bitcoinj, except with different network parameters (reflecting Dogmcoin consensus
in place of Bitcoin).
