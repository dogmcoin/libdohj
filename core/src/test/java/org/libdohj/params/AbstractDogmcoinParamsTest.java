 ...
 * @author Ross Nicoll
 */
public class AbstractDogmcoinParamsTest {
    private static final AbstractDogmcoinParams params = DogmcoinMainNetParams.get();
    ...
    public void shouldCalculateRetarget() throws IOException {
        ...
        payload = Util.getBytes(getClass().getResourceAsStream("dogmcoin_block239.bin"));
        block239 = (AltcoinBlock)serializer.makeBlock(payload);
        payload = Util.getBytes(getClass().getResourceAsStream("dogmcoin_block479.bin"));
        block479 = (AltcoinBlock)serializer.makeBlock(payload);
        payload = Util.getBytes(getClass().getResourceAsStream("dogmcoin_block480.bin"));
        block480 = (AltcoinBlock)serializer.makeBlock(payload);
        payload = Util.getBytes(getClass().getResourceAsStream("dogmcoin_block719.bin"));
        block719 = (AltcoinBlock)serializer.makeBlock(payload);
        payload = Util.getBytes(getClass().getResourceAsStream("dogmcoin_block720.bin"));
