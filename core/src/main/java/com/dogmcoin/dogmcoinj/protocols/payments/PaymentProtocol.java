...
package com.dogmcoin.dogmcoinj.protocols.payments;
...
public class PaymentProtocol {
    ...
    public static final String MIMETYPE_PAYMENTREQUEST = "application/vnd.dogm.payment.request";
    public static final String MIMETYPE_PAYMENT = "application/vnd.dogm.payment.payment";
    public static final String MIMETYPE_PAYMENTACK = "application/vnd.dogm.payment.ack";
