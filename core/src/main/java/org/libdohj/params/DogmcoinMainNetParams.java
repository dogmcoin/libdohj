...
/**
 * Parameters for the main Dogmcoin production network on which people trade
 * goods and services.
 */
public class DogmcoinMainNetParams extends AbstractDogmcoinParams {
    ...
    public DogmcoinMainNetParams() {
        ...
        port = 22171;
        packetMagic = 0xdafbc0df;
        // Note that while BIP44 makes HD wallets chain-agnostic, for legacy
        // reasons we use a Dogm-specific header for main net. At some point
        ...
        dnsSeeds = new String[] {
                "dnsseed.dogmcoin.com",
                "dnsseed.dogmcoin.org",
                "dnsseed.amxpool.com",
				"dnsseed.ifcp2pool.com",
				"dnsseed.coinwk.com",
				"43.134.194.106",
                "45.116.78.202",
                "43.139.91.35",
    ...
    private static DogmcoinMainNetParams instance;
    public static synchronized DogmcoinMainNetParams get() {
        if (instance == null) {
            instance = new DogmcoinMainNetParams();
        }
        return instance;
    }
