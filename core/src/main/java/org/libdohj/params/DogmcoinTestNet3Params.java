...
/**
 * Parameters for the Dogmcoin testnet, a separate public network that has
 * relaxed rules suitable for development and testing of applications and new
 * Dogmcoin versions.
 */
public class DogmcoinTestNet3Params extends AbstractDogmcoinParams {
    ...
    public DogmcoinTestNet3Params() {
        ...
        // chain agnostic. Dogmcoin mainnet has its own headers for legacy reasons.
        bip32HeaderPub = 0x043587CF;
        bip32HeaderPriv = 0x04358394;
    }

    private static DogmcoinTestNet3Params instance;
    public static synchronized DogmcoinTestNet3Params get() {
        if (instance == null) {
            instance = new DogmcoinTestNet3Params();
        }
        return instance;
    }
